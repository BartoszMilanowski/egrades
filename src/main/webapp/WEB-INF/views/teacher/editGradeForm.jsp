...
<head>
    ...
    <link
            ...
            rel="stylesheet">
    <script type="text/javascript" src="/js/validators/gradeFormValidator.js"></script>
    <title>Edytuj ocenę - ${student.lastName}</title>
</head>
<body>
...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Edytuj ocenę z przedmiotu: ${subject.subjectName},
                uczeń: ${student.lastName} ${student.firstName}</h6>
        </div>
        <div class="card-body">
            <form:form method="post" modelAttribute="grade" id="gradeForm">
